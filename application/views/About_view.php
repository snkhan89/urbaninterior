...
<div class="row">
<div class="col-lg-12">
<h3 class="page-header">View About Us</h3></div>
</div>
...
?>
   ...
   <td>
   <a href="<?php echo base_url();?>About/edit/<?php echo $data['id']; ?>" class="fa fa-pencil"></a>&nbsp&nbsp
   
   <?php  if($data['status'] == 0)
          { ?>
		  <a href="<?php echo base_url();?>About/status/<?php echo $data['id']; ?>" class="fa fa-check-circle" style="color:green;"></a>  
		  <?php }
		  else
		  { ?>
		  <a href="<?php echo base_url();?>About/status/<?php echo $data['id']; ?>" class="fa fa-times-circle" style="color:red;"></a>  
		  <?php }
	      ?>
   </td>
