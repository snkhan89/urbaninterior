...
<div class="row">
<div class="col-lg-12">
<h3 class="page-header">View Slider</h3></div>
</div>
...
?>
   ...
   <td>
   <img src="<?php echo base_url();?>slider/<?php echo $data['main_slider']; ?>" alt="img" width="240px" height="140px" />
   ...
   <?php  if($data['status'] == 0)
		  ...
		  { ?>
		  <a href="<?php echo base_url();?>Slider/status/<?php echo $data['id']; ?>" class="fa fa-times-circle" style="color:red;"></a>  
		  <?php }
	      ?>
   </td>
